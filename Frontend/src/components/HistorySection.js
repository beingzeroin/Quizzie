    ...
    if (loading) {
        ...
        return ( <
            div className = "history-section" > {
                ...
                p style = {
                    { textAlign: 'center' }
                } > You have not created any quizzes yet! < /p> : <
                GridList cols = { getCols() }
                className = "grid-list" > {
                    quizzes.map((quiz) => ( <
                        GridListTile key = { quiz._id }
                        className = "quiz-tile" >
                        <
                        img src = "../CC LOGO-01.svg" / >
                        <
                        GridListTileBar title = { quiz.quizName }
                        subtitle = { `By: You` }
                        actionIcon = { <
        ...
        return ( <
            div className = "history-section" > {
                ...
                p style = {
                    { textAlign: 'center' }
                } > You have not given any quizzes yet! < /p> : <
                ...
                className = "owner-quiz-list" > {
                    quizzes.map(quiz => (
                            ...
                            ( < ListItem button className = "owner-quiz-item"
                                ...
                                <
                                ListItemText primary = { quiz.quizId.quizName }
